...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"axios.js":[function(require,module,exports) {
"use strict";
...
axiosInstance.interceptors.response.use(function (res) {
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(error) {
    var _error$response;
    var originalRequest, res, newAccessToken, _t;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          console.log({
          ...
          if (!((error === null || error === void 0 || (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.status) === 401 && !originalRequest._retry)) {
            _context2.n = 4;
            break;
          }
          ...
          _context2.p = 1;
          _context2.n = 2;
          return _axios.default.post('/api/v1/users/refresh', {}, {
        ...
        case 2:
          ...
          return _context2.a(2, (0, _axios.default)(originalRequest));
        case 3:
          _context2.p = 3;
          _t = _context2.v;
...
var stripe = Stripe('pk_test_51S0RN3DNMLLrYvgtKRnBjvHktnBDfwUydBvQTscsJWmMbrsx65RBhJeLv8PebOXt0zPSj4EPtmGNOArR6L0ZRi7c00PZtfYybT');
...
},{"./axios":"axios.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var formElementMe = document.querySelector('.form-user-data');
var userPasswordData = document.querySelector('.form-user-password');
...
if (formElementMe) {
  formElementMe.addEventListener('submit', /*#__PURE__*/function () {
...
if (userPasswordData) {
  userPasswordData.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(e) {
      var currentPassword, updatedPassword, updatedConfirmPassword;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            ...
            updatedConfirmPassword = document.getElementById('password-confirm').value;
            _context2.n = 1;
